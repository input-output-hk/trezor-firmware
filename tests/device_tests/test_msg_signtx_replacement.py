...
def test_p2wpkh_payjoin(client):
    ...
    out1.amount = 10000 + 19899859 - 141  # Receiver pays entire original fee of 141.
    out2.amount = 100000 - 10000  # Sender pays no fee.
    inp2.witness = bytes.fromhex(
    ...
    out1.amount = 10000 + 19899859 - 200  # Receiver bumps fee from 141 to 200.
    out2.amount = 100000 - 10000  # Sender pays no fee.
    inp2.witness = bytes.fromhex(
